...
namespace NTC.GlobalStateMachine
{
    public static class GlobalStateMachine
    {
        ...
        public static void Push(GameStates state)
        {
            switch (state)
            {
                case GameStates.Idle: Push(new IdleState()); break;
                case GameStates.Paused: Push(new PausedState()); break;
                case GameStates.Fight: Push(new FightState()); break;
                case GameStates.Died: Push(new DiedState()); break;
                case GameStates.NPC: Push(new NPCState()); break;
